...
const distributionKey = {
  ...
  DistributionLevelUpgradeCondition_SelfDealMoney: 3, //自购交易金额
  ...
  DistributionLevelUpgradeCondition_AccumulatedRechargeAmount: 23, // 累计充值金额
  DistributionLevelUpgradeCondition_OneTimeRechargeAmount: 24, // 一次性充值金额
...
const conditionPerson = [
  ...
  },
  {
    ...
    tip: "XX会员等级所有直推成员（指分销商和会员）人数，不包括自己",
