<template>
  <div class="property-container">
    ...
    <div class="form">
      ...
      <div class="form-item">
        <div class="item-title">上传LOGO：</div>
        <div class="item-data">
      ...
      <div class="form-item" style="margin-bottom:0;">
        ...
        <RadioGroup v-model="module.qrtype" @on-change="checkState">
          <Radio :label="0">
            商城
            <more-message text="扫码后直接进入商城页面"></more-message>
          </Radio>
          <Radio :label="1">
            公众号
      ...
      <div v-if="Number(module.qrtype) === 0" class="form-item">
        <LinkButton
          style="flex:1;"
...
export default {
  ...
  created() {
    ...
    if (!this.module.linkinfo) {
      this.$set(this.module, "linkinfo", {
        link_type: "home",
        link_data: null,
        link_url: "#/",
        link_desc: "链接到 店铺首页"
